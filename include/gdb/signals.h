...
enum target_signal
  {
   ...
   /* CUDA - extra signals */
    TARGET_SIGNAL_CUDA_UNKNOWN_EXCEPTION,
    TARGET_SIGNAL_CUDA_LANE_ILLEGAL_ADDRESS,
    TARGET_SIGNAL_CUDA_LANE_USER_STACK_OVERFLOW,
    TARGET_SIGNAL_CUDA_DEVICE_HARDWARE_STACK_OVERFLOW,
    TARGET_SIGNAL_CUDA_WARP_ILLEGAL_INSTRUCTION,
    TARGET_SIGNAL_CUDA_WARP_OUT_OF_RANGE_ADDRESS,
    TARGET_SIGNAL_CUDA_WARP_MISALIGNED_ADDRESS,
    TARGET_SIGNAL_CUDA_WARP_INVALID_ADDRESS_SPACE,
    TARGET_SIGNAL_CUDA_WARP_INVALID_PC,
    TARGET_SIGNAL_CUDA_WARP_HARDWARE_STACK_OVERFLOW,
