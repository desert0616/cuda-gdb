...
static void
i386_darwin_dr_unset_status (unsigned long mask)
{
  unsigned long value;

  value = i386_darwin_dr_get (DR_STATUS);
  value &= ~mask;
  i386_darwin_dr_set (DR_STATUS, value);
}
 ...
 */
  ...
  i386_dr_low.reset_addr = i386_darwin_dr_reset_addr;
  i386_dr_low.get_status = i386_darwin_dr_get_status;
  i386_dr_low.unset_status = i386_darwin_dr_unset_status;
#ifdef BFD64
