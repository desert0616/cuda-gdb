...
void       modules_delete (modules_t modules, kernels_t kernels);
void       modules_add    (modules_t modules, module_t module);
void       modules_print  (modules_t modules);

void       modules_load_elf_images     (modules_t modules);
void       modules_unload_elf_images   (modules_t modules);
void       modules_resolve_breakpoints (modules_t modules, uint64_t context_id);
