...
pending_framepy_create_unwind_info (PyObject *self, PyObject *args)
{
  ...
  if (!gdbpy_ArgParseTuple (args, "O:create_unwind_info", &pyo_frame_id))
      return NULL;
              ...
              void **cache_ptr)
{
  ...
  pyo_unwind_info
      = gdbpy_ObjectCallFunctionObjArgs (pyo_execute, pyo_pending_frame, NULL);
  ...
  if (gdbpy_Object_IsInstance (pyo_unwind_info,
