		     ...
		     const char *xmethod_name)
{
  ...
  match_result = gdbpy_ObjectCallMethodObjArgs (matcher,
   ...
   xmethod_worker_vec **dm_vec)
{
  ...
  ALL_OBJFILES (objfile)
      ...
      if (py_objfile == NULL)
	{
      ...
      py_xmethod_matcher_list = gdbpy_Sequence_Concat (temp, objfile_matchers);
      Py_DECREF (temp);
  ...
  if (py_progspace != NULL)
    {
      ...
      py_xmethod_matcher_list = gdbpy_Sequence_Concat (temp, pspace_matchers);
      Py_DECREF (temp);
  ...
  if (gdb_python_module != NULL
	...
	{
	  py_xmethod_matcher_list = gdbpy_Sequence_Concat (temp, gdb_matchers);
	  Py_DECREF (temp);
			     ...
			     int *nargs, struct type ***arg_types)
{
  ...
  *nargs = -1;
  ...
  py_argtype_list = gdbpy_ObjectCallMethodObjArgs (py_worker,
