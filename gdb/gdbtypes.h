...
{
  TYPE_FLAG_UNSIGNED = (1 << 20),
  TYPE_FLAG_NOSIGN = (1 << 21),
  TYPE_FLAG_STUB = (1 << 22),
  TYPE_FLAG_TARGET_STUB = (1 << 23),
  TYPE_FLAG_STATIC = (1 << 24),
  TYPE_FLAG_PROTOTYPED = (1 << 25),
  TYPE_FLAG_INCOMPLETE = (1 << 26),
  TYPE_FLAG_VARARGS = (1 << 27),
  TYPE_FLAG_VECTOR = (1 << 28),
  TYPE_FLAG_FIXED_INSTANCE = (1 << 29),
  TYPE_FLAG_STUB_SUPPORTED = (1 << 30),
  TYPE_FLAG_GNU_IFUNC = (1 << 31),
